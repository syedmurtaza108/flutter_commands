...
class ApkCommand extends Command<int> {
  @override
  final name = 'apk';
  @override
  final description =
      'Wrapper for `flutter build apk --dart-define="env=env" --flavor flavor --target target`';
  ...
  Future<int> run() async {
    ...
    await FCMRunner.shell.run(
      '$flutterAlias build apk --release --dart-define="env=$env" --flavor $flavor --target $target',
    );
